...
const statusMap = {
  ...
  RECEIVED: { label: 'Đã thanh toán', color: 'bg-success-100 text-success-700 border-success-200' },
...
useEffect(() => {
  ...
  const orderTabs = [
    ...
    { id: 'RECEIVED', label: 'Đã thanh toán', count: orders?.filter(o => o.status === 'RECEIVED')?.length || 0 },
